...
class AerospaceEngineerAgent(CollegeAgent):
    college = "Engineering"
    expertise = (
        "Aerospace Engineering (propulsion, aerodynamics, space systems)"
    )
...
def _register_agents():
    ...
    for name, obj in inspect.getmembers(inspect.currentframe().f_globals):
        if (
            inspect.isclass(obj)
            and issubclass(obj, CollegeAgent)
            and obj != CollegeAgent
        ):
...
COLLEGE_MAPPING = {
    ...
    "Data & Analytics": [
        "DataScientistAgent",
        "StatisticianAgent",
        "GeospatialAnalystAgent",
        "ForecastingAgent",
        "OperationsResearchAgent",
    ],
    "Humanities": [
        "HistorianAgent",
        "PhilosopherEthicistAgent",
        "SociologistAgent",
        "LinguistAgent",
        "DesignCreativeAgent",
        "CognitivePsychologistAgent",
    ],
    "Engineering": [
        ...
        "RoboticsAgent",
        "AerospaceEngineerAgent",
    ],
    "Health & Medicine": [
        "MedicalDoctorAgent",
        "PharmacologistAgent",
        "NeuroscientistAgent",
        "BiomedicalEngineerAgent",
        "NutritionistAgent",
        "GeneticistAgent",
    ],
    "Environment & Climate": [
        ...
        "EcologistAgent",
        "HydrologistAgent",
        "DisasterResilienceAgent",
        "CircularEconomyAgent",
        "RenewableEnergyAgent",
        "UrbanPlannerAgent",
        "AgriculturalScientistAgent",
    ],
    "Security & Defense": [
        "RedTeamAgent",
        "CryptographerAgent",
        "SignalsIntelligenceAgent",
        "PrivacyOfficerAgent",
        "CybersecurityPolicyAgent",
    ],
    "Law & Policy": [
        "PatentExaminerAgent",
        "RegulatoryAffairsAgent",
        "InternationalTradeAgent",
        "ComplianceAgent",
    ],
    "Arts & Media": [
        "CopywriterAgent",
